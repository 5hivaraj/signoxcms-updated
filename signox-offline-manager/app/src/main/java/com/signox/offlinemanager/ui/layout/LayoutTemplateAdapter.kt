    ...
    inner class TemplateViewHolder(
        ...
        private fun drawTemplatePreview(template: LayoutTemplate) {
            ...
            val bitmap = android.graphics.Bitmap.createBitmap(
                200, 120, android.graphics.Bitmap.Config.ARGB_8888
            )
            ...
            canvas.drawRect(0f, 0f, 200f, 120f, backgroundPaint)
            ...
            template.sections.forEach { section ->
                val left = (section.x / 100f) * 200f
                val top = (section.y / 100f) * 120f
                val right = left + (section.width / 100f) * 200f
                val bottom = top + (section.height / 100f) * 120f
