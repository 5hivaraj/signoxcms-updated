...
class LayoutEditorActivity : AppCompatActivity() {
    ...
    private fun setupCanvasView() {
        binding.layoutCanvas.setOnZoneCreatedListener { x, y, width, height ->
            viewModel.createZone(x, y, width, height)
        }
        ...
        binding.buttonAddZone.setOnClickListener {
            binding.layoutCanvas.enterZoneCreationMode()
        }
    }
